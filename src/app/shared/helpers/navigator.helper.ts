export async function navigatorHelper () {
  ...
  let osVersion: string | null | RegExpExecArray = unknown;
...
export async function getPermissions() {
  return {
    geolocation: await getPermission({name: 'geolocation'}),
    notification: await getPermission({name: 'notifications'}),
    push: await getPermission({name: 'push', userVisibleOnly: true}),
  }
}
...
function getPermission(options: any): Promise<PermissionStatus> {
